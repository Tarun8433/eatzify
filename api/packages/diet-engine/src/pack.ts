/**
 * Shape of config/rule-packs/vX.Y.Z.yaml. The engine never reads the file — the caller parses and
 * validates it (zod, at boot) and passes the object in. That is what keeps this package I/O-free.
 */
...
export interface RulePack {
  ...
  readonly safety: {
    readonly floor_kcal: { readonly male: number; readonly female: number };
